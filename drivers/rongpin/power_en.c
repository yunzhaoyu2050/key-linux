...
static int power_en_probe(struct platform_device *pdev)
{
	...
	memset(data, 0, sizeof(struct power_en_gpio));
        ...
        data->gpio0.gpio_num = of_get_named_gpio_flags(np, "gpio0", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio0.gpio_num))
                data->gpio0.gpio_num = -1;
        else
        	data->gpio0.val = !gpio_flags;

        data->gpio1.gpio_num = of_get_named_gpio_flags(np, "gpio1", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio1.gpio_num))
                data->gpio1.gpio_num = -1;
        else
        	data->gpio1.val = !gpio_flags;

        data->gpio2.gpio_num = of_get_named_gpio_flags(np, "gpio2", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio2.gpio_num))
                data->gpio2.gpio_num = -1;
        else
        	data->gpio2.val = !gpio_flags;
                
        data->gpio3.gpio_num = of_get_named_gpio_flags(np, "gpio3", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio3.gpio_num))
                data->gpio3.gpio_num = -1;
        else
        	data->gpio3.val = !gpio_flags;
				
        data->gpio4.gpio_num = of_get_named_gpio_flags(np, "gpio4", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio4.gpio_num))
                data->gpio4.gpio_num = -1;
        else
        	data->gpio4.val = !gpio_flags;

        data->gpio5.gpio_num = of_get_named_gpio_flags(np, "gpio5", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio5.gpio_num))
                data->gpio5.gpio_num = -1;
        else
        	data->gpio5.val = !gpio_flags;

        data->gpio6.gpio_num = of_get_named_gpio_flags(np, "gpio6", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio6.gpio_num))
                data->gpio6.gpio_num = -1;
        else
        	data->gpio6.val = !gpio_flags;
                
        data->gpio7.gpio_num = of_get_named_gpio_flags(np, "gpio7", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio7.gpio_num))
                data->gpio7.gpio_num = -1;
        else
        	data->gpio7.val = !gpio_flags;

        data->gpio8.gpio_num = of_get_named_gpio_flags(np, "gpio8", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio8.gpio_num))
                data->gpio8.gpio_num = -1;
        else
        	{
        	data->gpio8.val = !gpio_flags;
        	otg_mode_gpio = data->gpio8.gpio_num;
        }
        	

        data->gpio9.gpio_num = of_get_named_gpio_flags(np, "gpio9", 0, &gpio_flags);
        if (!gpio_is_valid(data->gpio9.gpio_num))
                data->gpio9.gpio_num = -1;
        else
        	{
        	data->gpio9.val = !gpio_flags;
...
//      	        return ret;
			...
			gpio_direction_output(data->gpio0.gpio_num, data->gpio0.val);
        		gpio_set_value(data->gpio0.gpio_num, data->gpio0.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio1.gpio_num, data->gpio1.val);
        		gpio_set_value(data->gpio1.gpio_num, data->gpio1.val);
		}
	}
...
//			msleep(100);
			gpio_direction_output(data->gpio2.gpio_num, data->gpio2.val);
        		gpio_set_value(data->gpio2.gpio_num, data->gpio2.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio3.gpio_num, data->gpio3.val);
  			gpio_set_value(data->gpio3.gpio_num, data->gpio3.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio4.gpio_num, data->gpio4.val);
        		gpio_set_value(data->gpio4.gpio_num, data->gpio4.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio5.gpio_num, data->gpio5.val);
  			gpio_set_value(data->gpio5.gpio_num, data->gpio5.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio6.gpio_num, data->gpio6.val);
        		gpio_set_value(data->gpio6.gpio_num, data->gpio6.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio7.gpio_num, data->gpio7.val);
        		gpio_set_value(data->gpio7.gpio_num, data->gpio7.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio8.gpio_num, data->gpio8.val);
  			gpio_set_value(data->gpio8.gpio_num, data->gpio8.val);
		}
	}
...
//        	        return ret;
			...
			gpio_direction_output(data->gpio9.gpio_num, data->gpio9.val);
        		gpio_set_value(data->gpio9.gpio_num, data->gpio9.val);
		}
	}
